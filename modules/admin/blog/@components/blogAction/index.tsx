"use client";
import { useDeleteBlogMutation } from "@/appstore/blog/blog_api";
import { useDeleteCategoryMutation } from "@/appstore/blog/category_api";
import { useDeleteTagMutation } from "@/appstore/blog/tag_api";
import { Popconfirm, Tooltip, message } from "antd";
import Link from "next/link";
import { FiEdit, FiTrash2 } from "react-icons/fi";

const BlogAction = ({ record, isTrash }: any) => {
    ...
    <div className="">
      <div className="flex items-center justify-end gap-3">
        <div className="flex items-center gap-3">
          <Link href={`${`/admin/blog/edit/${record?.id}`}`}>
