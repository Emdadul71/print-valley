// "use client";
// import { useGetAllEventQuery } from "@/appstore/event/event_api";
...
//     title: "Programs",
//     dataIndex: "category",
//     render: (_, record: any) => <a>{record?.category?.name}</a>,
//   },
...
//     dataIndex: "action",
//     align: "end",
//     render: (_, record) => <EventAction record={record} />,
//   },
// ];
...
//   const { data, isLoading, isFetching } = useGetAllEventQuery(queryString);
